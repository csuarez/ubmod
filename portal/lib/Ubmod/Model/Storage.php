...
class Ubmod_Model_Storage
{
  ...
  public static function getActivityList(Ubmod_Model_QueryParams $params)
  {
    ...
    $qb->addSelectExpressions(array(
      ...
      'space_available'  => 'ROUND(AVG(space_available)     , 1)',
      'space_available'  => 'ROUND(MAX(space_available)     , 1)',
      ...
      'inodes_available' => 'ROUND(AVG(inodes_available)    , 1)',
      'inodes_available' => 'ROUND(MAX(inodes_available)    , 1)',
