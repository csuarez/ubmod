 ...
 * @package Ubmod
 */
class Ubmod_Handler_Storage extends Ubmod_BaseHandler
{

  /**
   * Help for the "storage" action.
   *
  ...
  public function activityAction(array $arguments, array $postData = null)
  {
    ...
    return Ubmod_RestResponse::factory(array(
      'results'  => Ubmod_Model_Storage::getActivityList($params),
      'total'    => Ubmod_Model_Storage::getActivityCount($params),
      'columns'  => Ubmod_Model_Storage::getColumns($params),
      'filename' => Ubmod_Model_Storage::getFilename($params),
    ));
  }
}
